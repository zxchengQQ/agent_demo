...
| 记忆管理 | 长期记忆 | 向量存储（规划中） | 🚧 |
| RAG 检索 | 文档加载 | PDF/Word/MD 加载 | ✅ |
| RAG 检索 | 文本分块 | 递归/Token 分块 | ✅ |
...
| **RAG 检索** | `agent-demo-rag` | 文档加载/分块/向量化/检索/Agent 工具集成/对话知识库集成 |
...
| RAG 检索 | 已实现（后端+前端） | 文档加载/分块/向量化/检索/前端管理界面 | 已解决 | 已解决 |
